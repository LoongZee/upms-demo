package com.loongzee.upms.dao;

import com.loongzee.common.util.MybatisGeneratorUtil;
 ...
 * @description: 代码生成类
 * @author: Loongzee
 * @create: 2019-04-06 19:19
 */
public class Generator {
    // 根据命名规范，只修改此常量值即可
    private static String MODULE = "upms";
    private static String DATABASE = "upmsdemo";
    private static String TABLE_PREFIX = "upms_";
    private static String PACKAGE_NAME = "com.loongzee.upms";
